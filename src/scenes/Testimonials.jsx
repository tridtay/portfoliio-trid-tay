  ...
  return (
    <section id="testimonials" className="pt-32 pb-16">
      ...
      >
        ...
        <p className="mt-10">TESTI text</p>
      </motion.div>
      ...
      <div className="md:flex md:justify-between gap-8">
        ...
        >
          ...
          <p className="text-center text-xl">person1 text</p>
        </motion.div>
        <motion.div
        ...
        >
          <p className="font-playfair text-6xl">“</p>
          <p className="text-center text-xl">person2 text</p>
        </motion.div>
        <motion.div
          className={`bg-yellow ${testimonialStyles} before:content-person1`}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
        ...
        >
          <p className="font-playfair text-6xl">"</p>
          <p className="text-center text-xl">person3 text</p>
        </motion.div>
      </div>
    </section>
  );
